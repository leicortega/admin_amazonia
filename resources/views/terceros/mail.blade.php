                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper">
                              <tr>
                                <td align="left" class="em_align_cent" style="text-align:center;font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789; text-decoration:none;">
                                  Respuesta a correo enviado a amazoniacl.com
                                </td>
                              </tr>
                            </table>
                          </td>
      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="https://amazoniacl.com/assets/img/page/logo.png" width="230" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
            </tr>
            <tr>
            ...
            <!-- === NEVIGATION SECTION === -->
            <tr>
              <td height="1" bgcolor="#66954c" style="font-size:0px; line-height:0px;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/spacer.gif" width="1" height="1" style="display:block;" border="0" alt="" /></td>
            </tr>
            <tr>
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b; text-transform:uppercase; font-weight:bold;" class="em_font">
                <a href="https://amazoniacl.com/" target="_blank" style="text-decoration:none; color:#30373b;">Inicio</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="https://amazoniacl.com/servicios" target="_blank" style="text-decoration:none; color:#30373b;">Servicios</a><span class="em_hide"> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; </span><span class="em_br"></span>
                <a href="https://amazoniacl.com/" target="_blank" style="text-decoration:none; color:#30373b;">Cotizar</a> &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp; 
                <a href="https://amazoniacl.com/contacto" target="_blank" style="text-decoration:none; color:#30373b;">Contactenos</a>
              </td>
            </tr>
            <tr>
              <td height="14" style="font-size:1px; line-height:1px;">&nbsp;</td>
            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td  align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#5a8d3e;">SE LE HA ASIGNADO UNA NUEVA CORRESPONDENCIA</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#000">
                        <pre>Cordial saludo {{$tipo == 'respuesta' ? $correspondencia['nombre'] : $correspondencia["name"]}}, 
@if ($tipo=='respuesta')
 {{$correspondencia['nombre']}} le ha dado una respuesta a una de sus correspondencias, para verla por favor dar click en el boton de abajo.
@else
Se le ha asignado una correspondencia, para verla por favor dar click en el boton de abajo.
@endif
...
<b>Amazonia C&L</b>
                  ...
                  <tr>
                    <td align="center" valign="top">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td bgcolor="#5a8d3e" width="1"></td>
                          <td align="center" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              <tr>
                                <td bgcolor="#5a8d3e" height="1" style="line-height:0px; font-size:0px;"></td>
                              </tr>
                              <tr>
                                <td height="36" class="em_height">&nbsp;</td>
                              </tr>
                              <tr>
                                <td   align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#5a8d3e;"><a href="#" target="_blank" style="color:#5a8d3e; text-decoration:none;"> {{$tipo=='respuesta' ? 'PARA VER LA RESPUESTA' : 'PARA VER ESTA CORRESPONDENCIA'}}</a></td>
                              </tr>
                              <tr>
                                  ...
                                  <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper" style="max-width:200px;">
                                    <tr>
                                      ...
                                      <td  width="45" bgcolor="#5a8d3e" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;">
                                          <a href="{{route('correspondencia_ver', $correspondencia->id)}}" target="_blank" style="color:#ffffff; text-decoration:none;"> CLIC AQUÍ</a>
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789;text-transform:uppercase;">
                &copy;2020 Amazonia C&L. Todos los derechos reservados.
              </td>
            </tr>
            <tr>
              <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
