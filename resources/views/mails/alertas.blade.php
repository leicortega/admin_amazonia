                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper">
                              <tr>
                                <td align="left" class="em_align_cent" style="text-align:center;font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789; text-decoration:none;">
                                  Correo generado automaticamente desde amazoniacl.com
                                </td>
                              </tr>
                            </table>
                          </td>
            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="41" class="em_height">
                        <p>DOCUMENTOS A VENCER</p>
                        <ul>
                            @foreach ($data['documetos_por_vencer'] as $vencer)
                                <li><b>{{ $vencer['documento'] }}</b> hasta <b>{{ $vencer['vigencia'] }}</b> del vehiculo <b>{{ $vencer['vehiculo'] }}</b>. <a href="https://admin.amazoniacl.com/vehiculos/ver/{{ $vencer['vehiculo_id'] }}">VER</a></li>
                            @endforeach
                        </ul>
                        ...
                        <ul>
                            @foreach ($data['documetos_vencidos'] as $vencidos)
                                <li><b>{{ $vencidos['documento'] }}</b> hasta <b>{{ $vencidos['vigencia'] }}</b> del vehiculo <b>{{ $vencidos['vehiculo'] }}</b>. <a href="https://admin.amazoniacl.com/vehiculos/ver/{{ $vencidos['vehiculo_id'] }}">VER</a></li>
                            @endforeach
                        </ul>
                    </td>
                  </tr>
