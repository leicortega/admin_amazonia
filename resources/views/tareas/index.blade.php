                    ...
                    <div class="card-body">
                        <div class="row p-xl-5 p-md-3">
                            <div class="table-responsive mb-3" id="Resultados">
                                ...
                                <button type="button" class="btn btn-primary btn-lg float-right mb-2" data-toggle="modal" data-target="#modal_agregar_tarea">Agregar +</button>
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="12" class="text-center">
                                                ...
                                                <span class="header-title mt-2">Tareas Pendientes</span>
                                            </th>
                                        </tr>
                                        <tr>
